<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <!-- Logo -->
                <div class="item shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        {{-- <x-jet-application-mark class="block h-9 w-auto" /> --}}
                        <img src="/images/logo_origin.png" class="block h-16 w-auto fill-current text-gray-600" />
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="item hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('covidInfo') }}" :active="request()->routeIs('covidInfo')">
                        {{ __('코로나 정보') }}
                    </x-jet-nav-link>
                </div>
                ...
                <div class="item flex-grow sm:items-center py-4 sm:pt-0">
                    @if (Route::has('login'))
                        <div class="hidden float-right px-6 py-5 sm:block">
                            @auth
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('profileShow') }}" :active="request()->routeIs('profileShow')">
                                {{ __('Profile') }}
                            </x-jet-dropdown-link>
...
{{--        </div>--}}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-jet-responsive-nav-link href="{{ route('profileShow') }}" :active="request()->routeIs('profileShow')">
                    {{ __('Profile') }}
                </x-jet-responsive-nav-link>
